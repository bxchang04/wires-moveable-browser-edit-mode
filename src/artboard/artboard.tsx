...
> {
  ...
  renderDemo = () => {
    ...
    const customElement3 = (
      ...
      >
        <div className="canvas" id="canvas">
          <div className="browser editable" id="component1">
            <div className="browser__header">
              <h2 className="browser__title input1">Webpage title</h2>
              <svg className="icon"><use href="#icon-minus"></use></svg>
              <svg className="icon"><use href="#icon-square"></use></svg>
              <svg className="icon"><use href="#icon-close"></use></svg>
            </div>

            <div className="browser__toolbar">
              <svg className="icon"><use href="#icon-arrow-left"></use></svg>
              <svg className="icon"><use href="#icon-arrow-right"></use></svg>
              <svg className="icon"><use href="#icon-refresh"></use></svg>
              <div className="browser__search input2">https://</div>
              <svg className="icon"><use href="#icon-ellipsis-vertical"></use></svg>
            </div>
          </div>
        </div>
      </BaseElement>
    ...
    const customElement4 = (
      ...
      >
        <div className="canvas" id="canvas">
          <div className="browser browser--no-borders editable">
            <div className="browser__header">
              <h2 className="browser__title input1">Webpage title</h2>
              <svg className="icon"><use href="#icon-minus"></use></svg>
              <svg className="icon"><use href="#icon-square"></use></svg>
